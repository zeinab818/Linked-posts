    ...
    <>
      <div className="dark:bg-gray-700 dark:text-gray-100 mt-8 py-5 px-3 bg-gray-200 rounded-3xl text-2xl lg:w-1/2 md:w-2/3 sm:w-full mx-auto">
        <div className="flex items-center justify-between">
          ...
          <Dropdown className="dark:text-gray-100">
            <DropdownTrigger>
            ...
            <DropdownMenu aria-label="Static Actions" className="bg-gray-800 dark:text-gray-100 dark:bg-gray-900">
              <DropdownItem key="upload" textValue="Upload Photo" className="dark:text-gray-100">
                <NavLink className="text-black dark:text-gray-100 hover:text-blue-500" to="/uploadPhoto">Upload Photo</NavLink>
              </DropdownItem>
              <DropdownItem key="changePass" textValue="Change Password" className="dark:text-gray-100">
                <NavLink className="text-black dark:text-gray-100 hover:text-blue-500" to="/changePassword">Change Password</NavLink>
              </DropdownItem>
            </DropdownMenu>
          </Dropdown>
        </div>
